<div class="dubai_moscow">

<div class="dubai">
    <div class="dutext">
        <h2>Car hire in Dubai for different budget</h2>
        <h4>We guarantee that you get technically sound, clean car with a full tank, comfortable interior. Our staff will independently pick up the car at the expiration of the rental term at the specified location.</h4>
...
<div class="moscow">
    ...
    <div class="mostext">
        ...
        <p>Для получения более подробной информации о прокате авто можно посетить наш офис, оставить заявку на сайте или позвонить
            по телефону <h4>7 (499) 110-20-47</h4></p>
